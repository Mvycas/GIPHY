...
function add_css(target) {
  (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.append_styles)(target, "svelte-kx0shs", "main.svelte-kx0shs{text-align:center;padding:1em;max-width:240px;margin:0 auto}img.svelte-kx0shs{width:100%;height:auto;border-radius:1rem;margin-bottom:1rem}.gif-layout.svelte-kx0shs{display:grid;grid-template-columns:repeat(auto-fit, minmax(250px, 1fr));grid-column-gap:1rem;grid-row-gap:2rem;margin-top:5rem}.search.svelte-kx0shs{display:flex;margin-left:auto;margin-right:auto;width:10em}.searchTerm.svelte-kx0shs{width:100%;position:relative;border:3px solid #00B4CC;border-right:none;height:20px;border-radius:5px 0 0 5px;outline:none;color:#9DBFAF;padding-bottom:0.93rem;padding-top:0.94rem}.searchTerm.svelte-kx0shs:focus{color:#00B4CC}.searchButton.svelte-kx0shs{width:40px;height:36px;border:1px solid #00B4CC;background:#00B4CC;text-align:center;color:#fff;border-radius:0 5px 5px 0;cursor:pointer;font-size:20px}@media(min-width: 640px){main.svelte-kx0shs{max-width:none}}");
}
...
function create_each_block(ctx) {
  ...
  return {
    c: function c() {
      ...
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr)(img, "alt", "gif");
      ...
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr)(img, "class", "svelte-kx0shs");
    },
...
function create_fragment(ctx) {
  ...
  return {
    c: function c() {
      ...
      head = (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.element)("head");
      ...
      body = (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.element)("body");
      ...
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr)(input, "class", "searchTerm svelte-kx0shs");
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr)(input, "placeholder", "search for a gif!");
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr)(button, "type", "submit");
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr)(button, "class", "searchButton svelte-kx0shs");
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr)(div0, "class", "search svelte-kx0shs");
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr)(div1, "class", "gif-layout svelte-kx0shs");
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr)(main, "class", "svelte-kx0shs");
    },
    m: function m(target, anchor) {
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.insert)(target, main, anchor);
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.append)(main, head);
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.append)(main, t0);
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.append)(main, body);
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.append)(body, div0);
      ...
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.append)(body, t2);
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.append)(body, div1);
      ...
      if (!mounted) {
        ...
        /*input_input_handler*/
        ctx[3]), (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.listen)(button, "click", function () {
...
function instance($$self, $$props, $$invalidate) {
  ...
  function findGIPHY(_x) {
    return _findGIPHY.apply(this, arguments);
  }

  function _findGIPHY() {
    _findGIPHY = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(phrase) {
      var response;
                  ...
                  return _regeneratorRuntime().wrap(function _callee$(_context) {
                    while (1) {
                      switch (_context.prev = _context.next) {
                        ...
                        case 2:
                          gifArray = _context.sent;

                          //add catch block here
                          for (i in gifArray.data) {
                            $$invalidate(1, gifs[i] = gifArray.data[i].images.downsized['url'], gifs);
                          }
  ...
  return [phrase, gifs, findGIPHY, input_input_handler];
}
